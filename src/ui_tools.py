...
class Ui_Tools(object):
    def setupUi(self, Tools):
        ...
        self.gridLayout_6.addWidget(self.label_14, 3, 1, 1, 1)
        self.username = QtWidgets.QLineEdit(parent=self.groupBox_5)
        self.username.setObjectName("username")
        self.gridLayout_6.addWidget(self.username, 2, 2, 1, 1)
        ...
        self.gridLayout_6.addWidget(self.label_10, 4, 2, 1, 2)
        ...
        self.gridLayout_6.addWidget(self.domain, 3, 2, 1, 1)
        ...
        spacerItem4 = QtWidgets.QSpacerItem(155, 20, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        spacerItem8 = QtWidgets.QSpacerItem(55, 20, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.gridLayout_2.addWidget(self.change_displays, 4, 2, 1, 1)
        ...
        spacerItem11 = QtWidgets.QSpacerItem(55, 20, QtWidgets.QSizePolicy.Policy.Fixed, QtWidgets.QSizePolicy.Policy.Minimum)
        ...
        self.gridLayout_5.addWidget(self.homedir, 1, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.clipboard, 1, 1, 1, 1)
        ...
        self.verticalLayout.addWidget(self.tab_tools)
        ...
        spacerItem13 = QtWidgets.QSpacerItem(148, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
    ...
    def retranslateUi(self, Tools):
        ...
        self.label_10.setText(_translate("Tools", "При подключение необходимо будет укаать учетные данные"))
